...
//TODO: This class requires refactoring. The simulation needs to be made generic. We can then have simulators for each model capable of calling this simulator. Maybe make this a trait?
